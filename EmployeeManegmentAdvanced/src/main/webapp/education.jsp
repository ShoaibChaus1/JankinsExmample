                ...
                <form action="addEducation" method="post">
                    ...
                    <div class="items">
                        <div class="data">
                            ...
                            <div class="inp"><input type="text" name="hg" id="cmid" value="<%=edb.getHg() %>" readonly >                           </div>
                        </div>
                    </div>
                    ...
                    <div class="items">
                        <div class="data">
                            ...
                            <div class="inp"><input type="text" name="fos" id="pmid" value="<%=edb.getFos() %>" readonly >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="items">
                        <div class="data">
                            ...
                            <div class="inp"><input type="text" name="marks" id="aphno" value="<%=edb.getMarks() %>%" readonly >                     </div>
                        </div>
                    </div>
                    ...
                    <div class="items">
                        <div class="data">
                            ...
                            <div class="inp"><input type="text" name="year" id="aphno"
                                    value="<%=edb.getYear() %>" readonly></div>
                        </div>
                    </div>
                    ...
                    <div class="items">
                        <div class="data">
                            ...
                            <div class="inp"><input type="text" name="type" value="<%=edb.getType() %>">
